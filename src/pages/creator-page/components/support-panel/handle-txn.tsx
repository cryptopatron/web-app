...
import { get_erc20_amount_string, get_erc20_address_by_symbol, get_erc20_amount_to_mint } from "../../../../Web3_Interaction/Utils";
...
export async function handle_mint_txn(setMsg, setErr, paymentDetails) {
    ...
    const params = {
        ...
        "token_address": get_erc20_address_by_symbol(paymentDetails.network, paymentDetails.currency_name)
    };
